...
def process_cutoff(sample_name, cutoff, umi_dict):
    outfile_fastq_r1_mode = os.path.join(outdir, "cutoff_" + str(cutoff), "mode", sample_name, "_1.fastq.gz")
    outfile_fastq_r2_mode = os.path.join(outdir, "cutoff_" + str(cutoff), "mode", sample_name, "_2.fastq.gz")
    outfile_count_mode = os.path.join(outdir, "cutoff_" + str(cutoff), "mode", sample_name, ".csv")

    outfile_fastq_r1_ld = os.path.join(outdir, "cutoff_" + str(cutoff), "ld", sample_name, "_1.fastq.gz")
    outfile_fastq_r2_ld = os.path.join(outdir, "cutoff_" + str(cutoff), "ld", sample_name, "_2.fastq.gz")
