process REPEAT_DIST_DISTANCE {
    ...
    tuple val(meta), path("4d_repeat_distribution_distance/frac_r1/*.csv"),        emit: frac_r1
    tuple val(meta), path("4d_repeat_distribution_distance/frac_r2/*.csv"),        emit: frac_r2
