process REPEAT_LENGTH_FRACTION {
    ...
    do
      repeat_length_fraction.py ${allele_number} ${prefix} repeat_length_count_default_umi_\$i.csv repeat_length_fraction_umi_\$i.csv $start_allele_1 $end_allele_1 $start_allele_2 $end_allele_2
    done
