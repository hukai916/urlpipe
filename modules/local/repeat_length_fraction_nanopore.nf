process REPEAT_LENGTH_FRACTION_NANOPORE {
    label 'process_low'
    ...
    do
      repeat_length_fraction.py ${allele_number} ${prefix} repeat_length_count_*_umi_\${i}.csv repeat_length_fraction_umi_\${i}_${prefix}.csv $start_allele_1 $end_allele_1 $start_allele_2 $end_allele_2
    done
